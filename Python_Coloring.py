...
#this is a variable to carry the file ext for later comparison
global ext
ext = ""
...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, document):
        ...
        CSRules += [(r'\b%s\b' % w, 0, STYLES['keyword'])
                    for w in PythonHighlighter.CSKeywords]
    ...
    def highlightBlock(self, text):
        ...
        #if any ext other than .py and .cs then do not format
        if ext != ".py" and ext != ".cs":
            return


#_________python ext found_____________________________________________________________________________
        elif ext == ".py":
...
#_______C# ext found________________________________________________________________________________
        elif ext == ".cs":
            # Do other syntax formatting
            ...
            # Do multi-line strings
            in_multiline = self.MatchMultilineCS(text, *self.CSmulticomment)
    ...
    def MatchMultilineCS(self, text, starter, delimiter, in_state, style):
